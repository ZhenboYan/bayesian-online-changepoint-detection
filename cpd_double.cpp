...
vector<double> ele_mul(const vector<double> &v1,const vector<double> &v2){
    vector<double> v;
...
vector<double> ele_mul3(const vector<double> &v1,const vector<double> &v2,const vector<double> &v3){
    vector<double> v;
    vector<double>::const_iterator it1 = v1.begin();
    vector<double>::const_iterator it2 = v2.begin();
    vector<double>::const_iterator it3 = v3.begin();
    for (int i = 0; i < v1.size();++i){
...
double sum_ele_mul3(const vector<double> &v1,const vector<double> &v2,const vector<double> &v3){
    double sum = 0;
    vector<double>::const_iterator it1 = v1.begin();
    vector<double>::const_iterator it2 = v2.begin();
    vector<double>::const_iterator it3 = v3.begin();
...
vector<double> ele_pow(const vector<double> &v1,const vector<double> &v2){
    vector<double> v;
    vector<double>::const_iterator it1 = v1.begin();
    vector<double>::const_iterator it2 = v2.begin();
    for (int i = 0; i < v1.size();++i){
...
vector<double> ele_div(const vector<double> &v1, const vector<double> &v2){
    vector<double> v;
    vector<double>::const_iterator it1 = v1.begin();
    vector<double>::const_iterator it2 = v2.begin();
    for (int i = 0; i < v1.size();++i){
...
vector<double> ele_add(const vector<double> &v1, const vector<double> &v2){
    vector<double> v;
    vector<double>::const_iterator it1 = v1.begin();
    vector<double>::const_iterator it2 = v2.begin();
    for (int i = 0; i < v1.size();++i){
...
vector<double> ele_sub(const vector<double> &v1, const vector<double> &v2){
    vector<double> v;
    vector<double>::const_iterator it1 = v1.begin();
    vector<double>::const_iterator it2 = v2.begin();
    for (int i = 0; i < v1.size();++i){
...
vector<double> all_add(const vector<double> &v1, const double &num){
    vector<double> v;
...
vector<double> all_sub(const vector<double> &v1, const double &num){
    vector<double> v;
    for (auto it = v1.begin(); it != v1.end(); ++it) 
        v.push_back(*it - num);
    return v;
...
vector<double> all_mul(const vector<double> &v1, const double &num){
    vector<double> v;
    for (auto it = v1.begin(); it != v1.end(); ++it) 
        v.push_back(*it * num);
    return v;
...
vector<double> all_div(const vector<double> &v1, const double &num){
    vector<double> v;
    for (auto it = v1.begin(); it != v1.end(); ++it) 
        v.push_back(*it / num);
    return v;
...
vector<double> all_pow(const vector<double> &v1, const double &num){
    vector<double> v;
    for (auto it = v1.begin(); it != v1.end(); ++it) 
...
vector<double> div_all(const vector<double> &v1, const double &num){
    vector<double> v;
    for (auto it = v1.begin(); it != v1.end(); ++it) 
        v.push_back(num / *it);
    return v;
...
vector<double> sub_all(const vector<double> &v1, const double &num){
    vector<double> v;
    for (auto it = v1.begin(); it != v1.end(); ++it) 
        v.push_back(num - *it);
    return v;
...
vector<double> gammaln(const vector<double> &v1){
    vector<double> v;
    vector<double>::const_iterator it1 = v1.begin();
    double solu;
    for (int i = 0; i < v1.size();++i){
...
vector<double> expvec(const vector<double> &v1){
    vector<double> v;
    vector<double>::const_iterator it1 = v1.begin();
    double solu;
    for (int i = 0; i < v1.size();++i){
...
vector<double> neg(const vector<double> &v1){
    vector<double> v;
    vector<double>::const_iterator it1 = v1.begin();
    double solu;
    for (int i = 0; i < v1.size();++i){
...
vector<double> hazard(const vector<double> &r, const double &lambda){
    if (lambda == 0)
        cout << "hazard failed division by zero";
    vector<double> ones(r.size(), 1);
    vector<double> v = all_mul(ones,1/lambda);
    return v;
}

vector<double> cal_c(const vector<double> &v2,const vector<double> &v3){
    vector<double> v;
    vector<double>::const_iterator var = v2.begin();
    vector<double>::const_iterator nu = v3.begin();
    double div2,add05,gl1,gl2,part3,mul_pi,mul_var,part4;
...
vector<double> studentpdf(const double &x, const vector<double> &mu, const vector<double> &var, const vector<double> &nu){
    vector<double> v;
    vector<double> cc = cal_c(var,nu);
    vector<double>::const_iterator va = var.begin();
    vector<double>::const_iterator n = nu.begin();
    vector<double>::const_iterator m = mu.begin();
    vector<double>::const_iterator c = cc.begin();

    double part5,part6,part7,part8;
...
vector<double> select(const vector<vector<double>> &matrix, int ls, int le, int r){
    vector<double> v;
    for (int i=ls;i<=le;++i)
...
void matrix_assign(vector<vector<double>> matrix, const vector<double> &v, const int &ls, const int &le, const int &r){
    int j = 0;
    for (int i=ls;i<le;++i){
        if (j >= v.size()){
            cout << "error length";
...
double sumvec(const vector<double> &v1){
    double sum = 0;
    vector<double>::const_iterator it1 = v1.begin();
    for (int i = 0; i < v1.size();++i){
        sum += *it1;
...
// vector<double> var1 = ele_mul(all_add(kappaT,1),betaT);
// vector<double> var2 = ele_mul(kappaT,alphaT);
// vector<double> var = ele_div(var1,var2);

vector<double> cal_var(const vector<double> &v1,const vector<double> &v2,const vector<double> &v3){
    vector<double> v;
    vector<double>::const_iterator a = v1.begin();
    vector<double>::const_iterator b = v2.begin();
    vector<double>::const_iterator k = v3.begin();
    double add_one,var1,var2;
    for (int i = 0; i < v1.size();++i){
        add_one = *k + 1;
        var1 = add_one * *b;
        var2 = *k * *a;
...
vector<double> cal_mu(double x, const vector<double> &v1,const vector<double> &v2){
    vector<double> v;
    vector<double>::const_iterator mu = v1.begin();
    vector<double>::const_iterator kappa = v2.begin();
    v.push_back(0);
    for (int i = 0; i < v1.size();++i){
...
vector<double> cal_kappa(const vector<double> &v1){
    vector<double> v;
    vector<double>::const_iterator kappa = v1.begin();
    v.push_back(1);
    for (int i = 0; i < v1.size();++i){
        v.push_back(*kappa + 1);
        kappa++;
...
vector<double> cal_alpha(const vector<double> &v1){
    vector<double> v;
    vector<double>::const_iterator alpha = v1.begin();
    v.push_back(1);
    for (int i = 0; i < v1.size();++i){
...
vector<double> cal_beta(double x, const vector<double> &v1,const vector<double> &v2,const vector<double> &v3){
    vector<double> v;
    vector<double>::const_iterator beta = v1.begin();
    vector<double>::const_iterator kappa = v2.begin();
    vector<double>::const_iterator mu = v3.begin();
    v.push_back(1);
    for (int i = 0; i < v1.size();++i){
...
int main() {
    vector<double> muT = {0}; //PASSED INTO FUNCTION
    vector<double> kappaT = {1}; //PASSED INTO FUNCTION
    vector<double> alphaT = {1}; //PASSED INTO FUNCTION
    vector<double> betaT  = {1}; //PASSED INTO FUNCTION
    
    // test examples
    double a[] = {1,2,3,4,5,6};
    vector<double> tt(begin(a), end(a));
    vector<double> t2 = all_add(tt,1);
    
    int n = 200;
    // 2D vector
    vector<vector<double>> matrix; //PASSED INTO FUNCTION
    vector<double> maxes(n+1, 1); //PASSED INTO FUNCTION
